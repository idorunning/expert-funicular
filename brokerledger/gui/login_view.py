...
class LoginView(QWidget):
    ...
    def __init__(self) -> None:
        ...
        title = QLabel(
            "<h1 style='margin:0'>BrokerLedger</h1>"
            "<p style='color:#666;margin-top:4px'>Local mortgage affordability analyser</p>"
        )
    ...
    def _open_forgot(self) -> None:
        dlg = _ForgotPasswordDialog(self, initial_email=self.identifier.text().strip())
        dlg.exec()
