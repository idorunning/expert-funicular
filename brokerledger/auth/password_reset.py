...
A user submits a request from the Login screen. An admin sees it in the Admin
Users view and resets the password in-app, then tells the user the new one.
No outbound email is used — the application is fully offline.
"""
